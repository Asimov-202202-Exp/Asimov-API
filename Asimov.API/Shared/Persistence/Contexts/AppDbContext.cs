    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Competence>().HasData(
                ...
                new Competence {Id = 4, Title = "Information processing and digital", Description = "This competence consists of having the skills to search, obtain, process and communicate information, and to transform it into knowledge. It incorporates different skills, ranging from access to information to its transmission on different media once it has been processed, including the use of information and communication technologies as an essential element to inform, learn and communicate.", CourseId = 11},
                new Competence {Id = 5, Title = "Social and civic", Description = "This competence makes it possible to understand the social reality in which we live, cooperate, live together and exercise democratic citizenship in a plural society, as well as commit to contributing to its improvement. In it are integrated diverse knowledge and complex skills that allow to participate, make decisions, choose how to behave in certain situations and take responsibility for the choices and decisions made.", CourseId = 7},
                new Competence {Id = 6, Title = "Cultural and artistic", Description = "This competence implies knowing, understanding, appreciating and critically evaluating different cultural and artistic manifestations, using them as a source of enrichment and enjoyment and considering them as part of the heritage of the peoples.", CourseId = 3},
                new Competence {Id = 7, Title = "learn to learn", Description = "Learning to learn means having the skills to start learning and being able to continue learning in an increasingly effective and autonomous way according to one's own objectives and needs.", CourseId = 5},
                new Competence {Id = 8, Title = "Autonomy and personal initiative", Description = "This competence refers, on the one hand, to the acquisition of awareness and application of a set of interrelated personal values attitudes, such as responsibility, perseverance, self-knowledge and self-esteem, creativity, self-criticism, emotional control, the ability to choose, calculate risks, and cope with problems, as well as the ability to delay the need for immediate satisfaction, to learn from mistakes, and to take risks.", CourseId = 10},
                new Competence {Id = 9, Title = "Mathematical reasoning", Description = "Ability to use and relate numbers and their basic operations, symbols and forms of expression and mathematical reasoning, both to produce and to interpret different types of information.", CourseId = 4},
                new Competence {Id = 10, Title = "Digital competence and information processing ", Description = "Skills in the treatment of information: search, obtain, process and communicate information and be able to transform it into knowledge.", CourseId = 8},
                new Competence {Id = 11, Title = "attitudes to continue learning autonomously throughout life ", Description = "Be aware of what you know, how you learn, and how you progress in learning.", CourseId = 12},
                new Competence {Id = 12, Title = "Basic Competences in didactic programming", Description = "Basic competencies must be incorporated into the didactic programming. Through them, students must acquire skills, knowledge and attitudes that have functional application in daily life. The competencies to be acquired and developed are", CourseId = 9}
            );
